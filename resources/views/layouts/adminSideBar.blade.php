    ...
    <aside class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-black  ">
        ...
        <div class= "max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            <a href="" class =  "hover:bg-white w-full text-white hover:text-black dark:hover:text-blue-500  p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                <i class="fas fa-columns w-4 h-4"></i>
                <div>
                    Dashboard
                </div>
            </a>
            <a href="{{route('category.index')}}" class =  "hover:bg-white w-full text-white hover:text-black dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">               
